...
export const EnvProvider = ({ children }) => {
  ...
  const [hzPresets, setHzPresets] = useState({
    ...
    earth: { atmos: 0.0, cloudCover: 0.45, cloudOpacity: 0.7,  seaLevel: 0.38, iceCap: 0.96, continentFreq: 0.16, warp: 0.5, rim: 0.0, rimFalloff: 1.0, rimDay: '#00aaff', rimTwi: '#ff6600', shell: 0.0, halo: 0.0, haloScale: 2.0, haloFalloff: 1.5 },
