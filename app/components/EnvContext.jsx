...
export const EnvProvider = ({ children }) => {
  ...
  const [hzPresets, setHzPresets] = useState({
    ...
    earth: { atmos: 0.0, cloudCover: 0.41, cloudOpacity: 0.89, cloudSwirl: 0.3, cloudBands: 2.5, cloudWarp: 0.5, seaLevel: 0.70, iceCap: 0.87, continentFreq: 0.30, warp: 0.5, rim: 0.10, rimFalloff: 1.0, rimDay: '#00aaff', rimTwi: '#ff6600', shell: 0.0, halo: 0.60, haloScale: 2.0, haloFalloff: 2.7, haloWhiten: 0.15, haloShadow: 0.7 },
