...
export const EnvProvider = ({ children }) => {
  ...
  const [hzPresets, setHzPresets] = useState({
    ...
    venusZone: { atmos: 0.0, rim: 0.0, rimFalloff: 0.7, rimDay: '#ccaa44', rimTwi: '#aa6622', shell: 0.0, halo: 0.50, haloScale: 2.5, haloFalloff: 1.5, haloWhiten: 0.35, haloShadow: 0.7 },
