...
export const EnvProvider = ({ children }) => {
  ...
  const [hzPresets, setHzPresets] = useState({
    mars:  { atmos: 0.0, cloudCover: 0.15, cloudOpacity: 0.2,  cloudSwirl: 0.3, cloudBands: 3.0, cloudWarp: 0.2, seaLevel: 0.15, iceCap: 0.98, iceEdge: 0.035, iceWarp: 0.4, iceDetail: 1.8, continentFreq: 0.10, warp: 0.3, rim: 0.0, rimFalloff: 1.5, rimDay: '#cc6644', rimTwi: '#884422', shell: 0.0, halo: 0.0, haloScale: 1.5, haloFalloff: 2.0, haloWhiten: 0.35, haloShadow: 0.7 },
    earth: { atmos: 0.0, cloudCover: 0.41, cloudOpacity: 0.89, cloudSwirl: 0.3, cloudBands: 2.5, cloudWarp: 0.5, seaLevel: 0.70, iceCap: 0.87, iceEdge: 0.035, iceWarp: 0.4, iceDetail: 1.8, continentFreq: 0.30, warp: 0.5, rim: 0.10, rimFalloff: 1.0, rimDay: '#00aaff', rimTwi: '#ff6600', shell: 0.0, halo: 0.60, haloScale: 2.0, haloFalloff: 2.7, haloWhiten: 0.15, haloShadow: 0.7 },
