...
const Star = (props) => {
  ...
  const lightRef = useRef();
      ...
      // const createRefs = () => {
      //   props.setRefs(prevState => ({
      //     current: [...prevState.current, system]
      //   }));
      // }
      ...
      useEffect(() => {
        ...
        // if(!props.refs.current.length){
        //   props.refs.current.push(system);
        //   console.log("empty");

        // }

        // if(props.refs && !props.refs.current.length){
        //   props.refs.current.push(system);
          // props.setRefsArray(system);
        // }
        ...
        // if(props.refs && !props.refs.current.length){
          ...
          // if (!props.refs.current.includes(system)) {
            // props.refs.current.push(system);
            // props.setRefsArray(system);
        ...
        console.log("render star", props.starSystemData.name[0]);

     

        
      }, [props.refs, props.setRefs, props.starSystemData.name]);
